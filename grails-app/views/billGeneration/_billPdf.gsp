...
<div class="sub-bill1">
    <header>
        ...
        <address>
           <p> <a href="https://hotel-invoice-app.scalingo.io/default/dash" style="font-weight: bold; font-size: 30px; padding-top: inherit">${hr.hotelName}</a></p>
    ...
    <article>
            ...
            <table class="inventory" style="padding-bottom: 0">
                ...
                <table class="" style="padding-top: 0; padding-left: 0">
                    <tr>
                        ...
                        <th colspan="2" style="width: 28%"><span>Other Extra Charges</span></th>
                        <td colspan="1" style="width: 24%"><span></span>RS. <span>${booking.billGeneration.otherCharges}</span></td>
                    </tr>
                    <tr>
        ...
        <div style="position:fixed; left:6%; bottom: 530px; width: 100%;">
            ...
            <p style="float: right">FOR ${hr.hotelName}
